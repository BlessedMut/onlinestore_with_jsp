		...
		<table class="table-hover table-condensed" align="center">
			...
			<tbody>
				<tr>
					...
					<td width="140"><strong>Payment Method</strong></td>
					<td width="300"><strong>Address</strong></td>
					<td width="100"><strong>Receiver</strong></td>
					<td width="70"><strong>Process</strong></td>
				</tr>
				...
				<tr>
					...
					<td><button class="btn btn-sm btn-success">Confirm
							Order</button></td>
				</tr>
				<tr>
					<td><br></td>
